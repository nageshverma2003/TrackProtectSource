...
namespace OAuth
{
    ...
    public class Manager
    {
        ...
        {
            get { return _params["consumer_key"]; }
            set { _params["consumer_key"] = value; }
        }

        public string ConsumerSecret
        {
            get { return _params["consumer_secret"]; }
            set { _params["consumer_secret"] = value; }
        }

        public string Callback
        {
            get { return _params["callback"]; }
            set { _params["callback"] = value; }
        }

        public string Token
        {
            get { return _params["token"]; }
            set { _params["token"] = value; }
        }

        public string TokenSecret
        {
            get { return _params["token_secret"]; }
            set { _params["token_secret"] = value; }
        }

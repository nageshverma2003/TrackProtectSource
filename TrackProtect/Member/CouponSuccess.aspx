<%@ Page Title="<%$ Resources: Resource, ttlHome %>" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="CouponSuccess.aspx.cs" Inherits="TrackProtect.Member.CouponSuccess" %>
        ...
        <div class="large-12 columns">
            ...
            <div class="row" style="padding-bottom: 30px;">
                ...
                <div class="large-8 columns pull-4">
                    ...
                    <div>
                        <asp:Literal runat="server" ID="CouponSuccessText" Text="<%$ Resources: Resource, CouponSuccess %>" />
                        <br />
                        <asp:Literal runat="server" ID="CouponCredits" Text="[credits]" />
                    </div>
                </div>
                <!-- End Miain Content -->
            </div>

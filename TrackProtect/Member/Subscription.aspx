<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Subscription.aspx.cs" Inherits="TrackProtect.Member.Subscription" %>
    ...
    <div id="contropanel" class="row">
        <div class="large-12 columns">
            <div class="section-title to-left hide-for-small">
                <h1>
                    <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources: Resource, Subscription %>" /></h1>
            </div>
            <div class="row">
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources: Resource, Subscription %>" /></h1>
                    </div>
                    <!-- What are coupon codes? -->
                    <div class="row">
                        <div class="large-11 columns">
                            <div>
                                <asp:Literal runat="server" ID="SubscriptionLiteral" />
                            </div>
                            <div style="margin-top: 10px;">
                                <label>
                                    <asp:Localize runat="server" ID="QuantityLabel" Text="<%$ Resources: Resource, QuotationHowMany %>" /></label>
                                <asp:TextBox runat="server" ID="QuantityEdit" CssClass="coupon" />
                                <div style="margin: 10px">
                                    <asp:RangeValidator runat="server" ID="rngvalquantity" ControlToValidate="QuantityEdit"
                                        MinimumValue="100" ErrorMessage="Value must be between 100 to 500." ValidationGroup="1"
                                        MaximumValue="500" Display="Dynamic" Type="Integer"></asp:RangeValidator></div>
                                <br />
                                <a href="SelectProduct.aspx">
                                    <input id="Button1" type="button" class="button small border edit" runat="server"
                                        value="<%$ Resources: Resource, Cancel %>" />
                                </a>
                                <asp:Button runat="server" ID="SubscriptionSubmit" Text="<%$ Resources: Resource, Pay %>"
                                    OnClick="SubscriptionSubmit_Click" CssClass="button right small border" ValidationGroup="1" />
                            </div>
                        </div>
                    </div>
                </div>

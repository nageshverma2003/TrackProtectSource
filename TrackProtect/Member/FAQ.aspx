<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="FAQ.aspx.cs" Inherits="TrackProtect.Member.FAQ" %>
            ...
            <div class="row" style="padding-bottom: 40px;">
                ...
                <div class="large-4 columns push-8">
                    ...
                    <div id="user-info">
                        ...
                        <section class="social-network"><div class="row collapse">
                        ...
                        <section class="actions"><div class="row collapse">
                        ...
                        <footer>
                            <a class="button extra-large expand border" href="Subscription.aspx?pid=4&country=NL&price=149,0000">upgrade plan</a> <a class="button extra-large expand"
                                ...
                                <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources : Resource, GetMore %>"></asp:Literal></a></footer>
                    </div>
                </div>
                <!-- End Right Column -->

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CouponCode.aspx.cs" Inherits="TrackProtect.Member.CouponCode" %>
    ...
    <div id="contropanel" class="row">
        <div class="large-12 columns" style="padding-bottom: 50px;">
            <div class="section-title to-left hide-for-small">
                <h1>
                    <asp:Localize runat="server" Text="<%$ Resources : Resource, COUPONS %>"></asp:Localize></h1>
            </div>
            <div class="row">
                <!-- Right Column -->
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources : Resource, COUPONS %>"></asp:Localize></h1>
                    </div>
                    <!-- What are coupon codes? -->
                    <div class="row">
                        <!-- Just to add padding on the right -->
                        <div class="large-11 columns">
                            <asp:Literal runat="server" ID="ltrlCouponCode"></asp:Literal>
                            <!-- Coupon Code Form -->
                            <asp:Panel ID="couponcode" runat="server" DefaultButton="CouponCodeGo">
                                <label>
                                    Enter Your Coupon Code</label><asp:TextBox runat="server" ID="CouponCodeEdit" CssClass="couponCodeEdit" />
                                <asp:Button runat="server" ID="CouponCodeGo" Text="ADD COUPON" CssClass="button small border right"
                                    OnCommand="CouponCodeGoCommand" />
                            </asp:Panel>

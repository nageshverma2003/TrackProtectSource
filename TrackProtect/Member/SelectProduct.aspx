<%@ Page Title="<%$ Resources: Resource, ttlHome %>" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="SelectProduct.aspx.cs" Inherits="TrackProtect.Member.SelectProduct" %>
    ...
    <div id="contropanel" class="row">
        <div class="large-12 columns">
            ...
            <div class="section-title to-left hide-for-small">
                <h1>
                    <asp:Localize ID="Localize3" runat="server" Text="<%$ Resources: Resource, DefaultProductHeading %>"></asp:Localize>
                </h1>
            </div>
            <div class="row">
                <!-- Right Column -->
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources: Resource, DefaultProductHeading %>" /></h1>
                    </div>
                    <div>
                        <div id="products" class="row" data-magellan-destination="products">
                            <div class="large-12 columns">
                                <asp:DataList ID="ProductList" runat="server" EnableViewState="true" RepeatDirection="Horizontal"
                                    RepeatColumns="1">
                                    <ItemTemplate>
                                        <div class="row">
                                            <div class="columns">
                                                <div>
                                                    <div style="margin-top: 7px;" class="large-4 columns hide-for-small icon-img">
                                                        <i class="icon-logo"></i>
                                                    </div>
                                                    <div class="large-8 small-12 columns">
                                                        <h2>
                                                            <%#Eval("ProductPlan")%><span id="credits" runat="server" class="number">
                                                                <%#Eval("Credits")%></span>
                                                        </h2>
                                                        <p class="description">
                                                            <%#Eval("ProductDesc")%></p>
                                                        <div class="row footnote">
                                                            <div class="large-6 large-offset-1 small-12 columns">
                                                                <span>
                                                                    <%#Eval("ProductPrice")%></span>
                                                            </div>
                                                            <div class="large-5 small-12 columns">
                                                                <asp:HyperLink ID="HLBuyProduct" runat="server" class="button">
                                                                    <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources : Resource, BuyNowSelectProduct %>"></asp:Localize></asp:HyperLink><b>
                                                                        <h3 class="price" style="width: 57px; float: right; color: Black;">
                                                                            <%#Eval("Price")%></h3>
                                                                    </b>
                                                            </div>
                                                            <asp:Label ID="hdnCreditValue" runat="server" Text='<%#Eval("Credits")%>' Visible="false" />
                                                            <asp:Label ID="hdnProductID" runat="server" Text='<%#Eval("ProductId")%>' Visible="false" />
                                                            <asp:Label ID="hdnProductExtra" runat="server" Text='<%#Eval("Extra")%>' Visible="false" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="UploadConfirmation.aspx.cs" Inherits="TrackProtect.Member.UploadConfirmation" %>
            ...
            <div class="row">
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize runat="server" Text="<%$ Resources : Resource, ProtectTrackResult %>"></asp:Localize></h1>
                    </div>
                    <div class="row collapse tracks">
                        <br />
                        <div id="divTrackProtected" runat="server" visible="false">
                            <asp:Label ID="TrackProtected" runat="server"> </asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divSoundCloudPost" runat="server" visible="false">
                            <asp:Label ID="SoundCloudPost" runat="server"> </asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divFacebookPost" runat="server" visible="false">
                            <asp:Label ID="FacebookPost" runat="server"> </asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divFacebookGenreCommunityPost" runat="server" visible="false">
                            <asp:Label ID="FacebookGenreCommunityPost" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divFacebookSubGenreCommunityPost" runat="server" visible="false">
                            <asp:Label ID="FacebookSubGenreCommunityPost" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divPostOnFriendWall" runat="server" visible="false">
                            <asp:Label ID="PostOnFriendWall" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divPostOnPages" runat="server" visible="false">
                            <asp:Label ID="PostOnPages" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divPostToOwnWall" runat="server" visible="false">
                            <asp:Label ID="PostToOwnWall" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divPostOnMyFriendWall" runat="server" visible="false">
                            <asp:Label ID="PostOnMyFriendWall" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divPostOnMyPages" runat="server" visible="false">
                            <asp:Label ID="PostOnMyPages" runat="server"></asp:Label>
                            <br />
                            <br />
                        </div>
                        <div id="divTwitterpost" runat="server" visible="false">
                            <asp:Label ID="Twitterpost" runat="server"> </asp:Label>
                            <br />
                            <br />
                        </div>
                        <br />
                        <asp:Button CssClass="button small border" runat="server" Text="View Protected Track !" ID="ViewTrack"
                            OnCommand="ViewTrack_Command" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <asp:Button CssClass="button small border" runat="server" Text="Control Panel" ID="NavigateControlPanel"
                            OnCommand="NavigateControlPanel_Command" />
                    </div>
                </div>
                <!-- End Miain Content -->
            </div>

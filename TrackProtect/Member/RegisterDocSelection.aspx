<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegisterDocSelection.aspx.cs" Inherits="TrackProtect.Member.RegisterDocSelection" %>
            ...
            <div class="row">
                    ...
                    <div id="user-info">
                        ...
                        <section class="actions">
                            <div class="row collapse">
                                <a href="../Account/ChangePassword.aspx" class="box small-12 columns">
                                    <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources : Resource, ChangePassword %>"></asp:Localize></a>
                            </div>
                        ...
                        <footer>
                            <a class="button extra-large expand border" href="Subscription.aspx?pid=4&country=NL&price=149,0000">upgrade plan</a> <a class="button extra-large expand"
                                ...
                                <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources : Resource, GetMore %>"></asp:Literal></a>
                        </footer>
                    </div>
                </div>
                <!-- End Right Column -->
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources : Resource, ProtectTrackText %>"></asp:Localize></h1>
                    </div>
                    <div class="row collapse tracks">
                        ...
                        action="#">
                        <br />
                        <a href="RegisterDocument.aspx?Mode=Self">
                            <input id="Button1" type="button" class="button small border edit" runat="server"
                                value="<%$ Resources: Resource, ProtectTrackForSelf %>" />
                        </a><a href="RegisterDocManaged.aspx">
                            <input id="Button2" type="button" class="button small border edit" runat="server"
                                value="<%$ Resources: Resource, ProtectTrackForManagedArtist %>" />
                        </a>
                        </form>

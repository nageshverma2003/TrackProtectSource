<%@ Page Title="<%$ Resources: Resource, ttlHome %>" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="PayResult.aspx.cs" Inherits="TrackProtect.PayResult" %>
    ...
    <div id="contropanel" class="row">
        <div class="large-12 columns">
            <div class="section-title to-left hide-for-small">
                <h1>
                    <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources: Resource, PaymentResult %>"></asp:Localize></h1>
            </div>
            <div class="row" style="padding-bottom: 30px;">
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources: Resource, PaymentResult %>"></asp:Localize></h1>
                    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="InviteSuccess.aspx.cs" Inherits="TrackProtect.Member.InviteSuccess" %>
            ...
            <div class="row">
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources: Resource, InviteSuccessful %>" /></h1>
                    </div>
                    <div>
                        <asp:Literal runat="server" ID="InviteSuccessLiteral" />
                        <br />
                        <br />
                        <a href="Invitation.aspx">
                            <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources: Resource, BackToRelations %>" /></a>
                    </div>
                </div>
                <!-- End Miain Content -->
            </div>

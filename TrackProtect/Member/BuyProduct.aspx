<%@ Page Title="<%$ Resources: Resource, ttlHome %>" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="BuyProduct.aspx.cs" Inherits="TrackProtect.BuyProduct" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" language="javascript" src="../Scripts/showdiv.js"></script>
    <asp:Literal runat="server" ID="BuyProductInc" Visible="false" />
    ...
    <div id="contropanel" class="row">
        <div class="large-12 columns">
            ...
            <asp:Literal runat="server" ID="Literal2" Visible="false" />
            <div class="section-title to-left hide-for-small">
                <h1>
                    <asp:Localize runat="server" Text='<%$ Resources : Resource, ProductInfo %>'></asp:Localize></h1>
            </div>
            <div class="row">
                <!-- Right Column -->
                <div class="large-4 columns push-8">
                    ...
                    <div id="user-info">
                        ...
                        <section class="actions">
                              <div class="row collapse">
                                <a href="../Account/ChangePassword.aspx" class="box small-12 columns"><asp:Localize ID="Localize2" runat="server" Text="<%$ Resources : Resource, ChangePassword %>"></asp:Localize></a>
                              </div>
                ...
                <div class="large-8 columns pull-4">
                    <div class="section-title small to-left show-for-small">
                        <h1>
                            <asp:Localize ID="Localize1" runat="server" Text='<%$ Resources : Resource, ProductInfo %>'></asp:Localize></h1>
                    </div>
                    <div>
                        <asp:Literal runat="server" ID="ProductInc" />
                        <a href="SelectProduct.aspx">
                            <input type="button" class="button small border edit" runat="server" value="<%$ Resources: Resource, Cancel %>" />
                        </a>
                        <asp:Button ID="SubmitButton" Text="<%$ Resources: Resource, Pay %>" runat="server"
                            OnCommand="SubmitButton_Command" CssClass="button small border edit right pay_btn "  />
                        <p>
                            <asp:Literal ID="ResultMessage" runat="server"></asp:Literal></p>
                    </div>
                </div>
                <!-- End Miain Content -->
            </div>

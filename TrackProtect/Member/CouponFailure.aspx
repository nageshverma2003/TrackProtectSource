<%@ Page Title="<%$ Resources: Resource, ttlHome %>" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="CouponFailure.aspx.cs" Inherits="TrackProtect.Member.CouponFailure" %>
        ...
        <div class="large-12 columns">
            ...
            <div class="row" style="padding-bottom: 30px;">
                ...
                <div class="large-8 columns pull-4">
                    ...
                    <div>
                        <asp:Literal runat="server" ID="CouponFailureText" Text="<%$ Resources: Resource, CouponFailure %>" />
                        <br />
                        <asp:Literal runat="server" ID="ErrorCode" Text="[error]"></asp:Literal>
                    </div>
                </div>
                <!-- End Miain Content -->
            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="InviteFriends.aspx.cs" Inherits="TrackProtect.Member.InviteFriends" %>
                ...
                <div class="large-8 columns pull-4">
                    ...
                    <div>
                        ...
                        <div class="large-11 columns">
                            <%--<asp:GridView ID="GridViewFriendList" AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#F0F8FF"
                                runat="server">
                                <HeaderStyle BackColor="#006699" BorderStyle="Groove" ForeColor="White" Height="35px"
                                    Font-Size="12px" />
                                <RowStyle ForeColor="Black" Font-Size="12px" Font-Bold="false" Height="30px" />
                                <Columns>
                                    <asp:TemplateField HeaderText="ID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="FriendID" runat="server" Text='<%# Bind("") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Image" Visible="true">
                                        <ItemTemplate>
                                            <asp:Image ID="FriendImage" runat="server" ImageUrl='<%# Bind("") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Name" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="FriendName" runat="server" Text='<%# Bind("") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkBxSelect" runat="server" />
                                            <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Bind("flight_id") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>--%>
